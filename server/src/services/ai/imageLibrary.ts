...
export const COUNTRY_FLAGS: Record<string, string> = {
  ...
  // Ek ülkeler (100+ benzersiz ülke garantisi)
  arnavutluk: 'al',
  albania: 'al',
  'kuzey makedonya': 'mk',
  'north macedonia': 'mk',
...
export const LOGO_IMAGES: Record<string, string> = {
  ...
  // Ek marka logoları - Part 1 (finans / teknoloji / sosyal medya)
  mastercard: 'https://commons.wikimedia.org/wiki/Special:FilePath/Mastercard-logo.svg?width=960',
  visa: 'https://commons.wikimedia.org/wiki/Special:FilePath/Visa_Inc._logo.svg?width=960',
  americanexpress: 'https://commons.wikimedia.org/wiki/Special:FilePath/American_Express_logo_(2018).svg?width=960',
  amex: 'https://commons.wikimedia.org/wiki/Special:FilePath/American_Express_logo_(2018).svg?width=960',
  paypal: 'https://commons.wikimedia.org/wiki/Special:FilePath/PayPal_logo.svg?width=960',
  ebay: 'https://commons.wikimedia.org/wiki/Special:FilePath/EBay_logo.svg?width=960',
  linkedin: 'https://commons.wikimedia.org/wiki/Special:FilePath/LinkedIn_2023.svg?width=960',
  pinterest: 'https://commons.wikimedia.org/wiki/Special:FilePath/Pinterest-logo.png?width=960',
  snapchat: 'https://commons.wikimedia.org/wiki/Special:FilePath/Snapchat_logo.svg?width=960',
  reddit: 'https://commons.wikimedia.org/wiki/Special:FilePath/Reddit_logo.svg?width=960',
  discord: 'https://commons.wikimedia.org/wiki/Special:FilePath/Discord_logo.svg?width=960',
  twitch: 'https://commons.wikimedia.org/wiki/Special:FilePath/Twitch_logo.svg?width=960',
  zoom: 'https://commons.wikimedia.org/wiki/Special:FilePath/Zoom_Communications_Logo.svg?width=960',
  slack: 'https://commons.wikimedia.org/wiki/Special:FilePath/Slack_Technologies_Logo.svg?width=960',
  ibm: 'https://commons.wikimedia.org/wiki/Special:FilePath/IBM_logo.svg?width=960',
  intel: 'https://commons.wikimedia.org/wiki/Special:FilePath/Intel_logo_(2020).svg?width=960',
  nvidia: 'https://commons.wikimedia.org/wiki/Special:FilePath/NVIDIA_logo.svg?width=960',
  amd: 'https://commons.wikimedia.org/wiki/Special:FilePath/AMD_logo.svg?width=960',
  canon: 'https://commons.wikimedia.org/wiki/Special:FilePath/Canon_logo.svg?width=960',
  panasonic: 'https://commons.wikimedia.org/wiki/Special:FilePath/Panasonic_logo.svg?width=960',
  philips: 'https://commons.wikimedia.org/wiki/Special:FilePath/Philips_logo.svg?width=960',
  lg: 'https://commons.wikimedia.org/wiki/Special:FilePath/LG_logo_(2015).svg?width=960',
  xiaomi: 'https://commons.wikimedia.org/wiki/Special:FilePath/Xiaomi_logo.svg?width=960',
  huawei: 'https://commons.wikimedia.org/wiki/Special:FilePath/Huawei_logo_icon.svg?width=960',
  lenovo: 'https://commons.wikimedia.org/wiki/Special:FilePath/Lenovo_logo.svg?width=960',
  dell: 'https://commons.wikimedia.org/wiki/Special:FilePath/Dell_2016_logo.svg?width=960',
  hp: 'https://commons.wikimedia.org/wiki/Special:FilePath/HP_logo_2012.svg?width=960',
  asus: 'https://commons.wikimedia.org/wiki/Special:FilePath/ASUS_Logo.svg?width=960',
  logitech: 'https://commons.wikimedia.org/wiki/Special:FilePath/Logitech_logo.svg?width=960',

  // Ek marka logoları - Part 2 (gıda / içecek)
  sprite: 'https://commons.wikimedia.org/wiki/Special:FilePath/Sprite_Logo.svg?width=960',
  fanta: 'https://commons.wikimedia.org/wiki/Special:FilePath/Fanta_logo.svg?width=960',
  mountaindew: 'https://commons.wikimedia.org/wiki/Special:FilePath/Mountain_Dew_logo.svg?width=960',
  'mountain dew': 'https://commons.wikimedia.org/wiki/Special:FilePath/Mountain_Dew_logo.svg?width=960',
  nestle: 'https://commons.wikimedia.org/wiki/Special:FilePath/Nestl%C3%A9.svg?width=960',
  nestlé: 'https://commons.wikimedia.org/wiki/Special:FilePath/Nestl%C3%A9.svg?width=960',
  danone: 'https://commons.wikimedia.org/wiki/Special:FilePath/Danone_logo.svg?width=960',
  colgate: 'https://commons.wikimedia.org/wiki/Special:FilePath/Colgate_logo.svg?width=960',
  loreal: 'https://commons.wikimedia.org/wiki/Special:FilePath/L%27Or%C3%A9al_logo.svg?width=960',
  nivea: 'https://commons.wikimedia.org/wiki/Special:FilePath/Nivea_logo.svg?width=960',
  dove: 'https://commons.wikimedia.org/wiki/Special:FilePath/Dove_brand_logo.svg?width=960',
  kelloggs: 'https://commons.wikimedia.org/wiki/Special:FilePath/Kellogg%27s_logo.svg?width=960',
  "kellogg's": 'https://commons.wikimedia.org/wiki/Special:FilePath/Kellogg%27s_logo.svg?width=960',
  heinz: 'https://commons.wikimedia.org/wiki/Special:FilePath/Heinz_logo.svg?width=960',
  kraft: 'https://commons.wikimedia.org/wiki/Special:FilePath/Kraft_Foods_logo.svg?width=960',
  cadbury: 'https://commons.wikimedia.org/wiki/Special:FilePath/Cadbury_Logo.svg?width=960',
  mars: 'https://commons.wikimedia.org/wiki/Special:FilePath/Mars%2C_Incorporated_logo.svg?width=960',
  snickers: 'https://commons.wikimedia.org/wiki/Special:FilePath/Snickers_logo.svg?width=960',
  ferrero: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ferrero_Logo.svg?width=960',
  nutella: 'https://commons.wikimedia.org/wiki/Special:FilePath/Nutella_2015.svg?width=960',
  kinder: 'https://commons.wikimedia.org/wiki/Special:FilePath/Kinder_logo.svg?width=960',
  pringles: 'https://commons.wikimedia.org/wiki/Special:FilePath/Pringles_logo.svg?width=960',
  lays: 'https://commons.wikimedia.org/wiki/Special:FilePath/Lay%27s_logo.svg?width=960',
  "lay's": 'https://commons.wikimedia.org/wiki/Special:FilePath/Lay%27s_logo.svg?width=960',
  doritos: 'https://commons.wikimedia.org/wiki/Special:FilePath/Doritos_Logo.svg?width=960',
  oreo: 'https://commons.wikimedia.org/wiki/Special:FilePath/Oreo_logo.svg?width=960',
